...
public class ServiceReponse implements IService<ReponseReclamation> {
    ...
    @Override
    public boolean edit(ReponseReclamation t) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public boolean add(ReponseReclamation t) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
          public int calculer(int idtype) {
          int l = 0 ;
         String requete = "SELECT COUNT(*) FROM reponse_reclamation WHERE reclamation_id= "+idtype ;
        try {
